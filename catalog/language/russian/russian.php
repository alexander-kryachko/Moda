...
$_['button_continue_buy']   = 'Продолжить покупки';
$_['button_checkout_now']   = 'Оформить заказ';
$_['text_price_unit']       = 'Цена за 1 ед.';
$_['text_price_total']      = 'Общая цена';
...
// Buttons
$_['callme_text']           = 'Заказать обратный звонок';
...
$_['button_wishlist_in']    = 'Уже в закладках';
...
$_['counter_text_prepend'] = '<span class="notes">До конца акции осталось</span>';
$_['counter_text_days'] = 'Д.';
$_['counter_text_timeup'] = '<span class="times-up">Акция окончена</span>';
