          ...
          <select name="<?php echo $name; ?>[<?php echo $f['id']; ?>]" 
            ...
            <?php if(!empty($f['options'])) { ?>
                <?php foreach ($f['options'] as $option) { ?>
                    ...
                    <option value="<?php echo $option['value']; ?>" selected="selected"><?php if ( !empty($option['name']) ) { echo $option['name']; } else { echo $option['title']; } ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $option['value']; ?>"><?php if ( !empty($option['name']) ) { echo $option['name']; } else { echo $option['title']; } ?></option>
                    <?php } ?>
                <?php } ?>
            <?php } ?>
          </select>
