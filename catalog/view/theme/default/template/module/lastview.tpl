<div class="moduleBox latestview">
        ...
        <div class="image">
          <a href="<?php echo $product['href']; ?>">
            <?php if($product['special_end'] > 0):?>
              <span class="counter" id="counter_<?php print $product['product_id'];?>_latestview"></span>
              <script>counter($('#counter_<?php print $product['product_id']?>_latestview'), <?php print $product['special_end']; ?>);</script>
            <?php endif;?>
