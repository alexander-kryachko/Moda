...
class ModelCatalogOption extends Model {
	public function addOption($data) {
		...
		/** Custom fields **/
		$this->db->query("INSERT INTO `" . DB_PREFIX . "option` SET type = '" . $this->db->escape($data['type']) . "', style = '" . $this->db->escape($data['style']) . "', sort_order = '" . (int)$data['sort_order'] . "' " . $product_page);
	...
	public function editOption($option_id, $data) {
		...
		/** Custom fields **/
		$this->db->query("UPDATE `" . DB_PREFIX . "option` SET type = '" . $this->db->escape($data['type']) . "', style = '" . $this->db->escape($data['style']) . "', sort_order = '" . (int)$data['sort_order'] . "' {$product_page} WHERE option_id = '" . (int)$option_id . "'");
