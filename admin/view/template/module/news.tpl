    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-news" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-html-tpl">Название шаблона</label>
            <div class="col-sm-10">
              <input type="text" name="html_tpl" value="<?php echo $html_tpl; ?>" placeholder="Название шаблона" id="input-html-tpl" class="form-control" />
            </div>
          </div>
