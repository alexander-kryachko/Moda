<ul id="menu">
  ...
  <li id="extension">
    ...
    <ul>
      <?php if($has_permission->hasPermission('access', 'module/reviews')){?>
      ...
      <?php }?>
        <?php if($has_permission->hasPermission('access', 'module/complaints')){?>
        <li><a href="<?php echo $faq_complaints; ?>">FAQ - Книга жалоб и предложений</a></li>
      <?php }?>
    </ul>
  </li>
