<?php echo $header; ?><?php echo $column_left; ?>
	...
	<div class="container-fluid">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				<label class="col-xs-2 control-label">Стиль CSS</label>
				<div class="col-xs-10">
					<input type="text" name="style" value="<?php echo $style ?>" class="form-control" placeholder="Стиль CSS" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="btn-group" data-toggle="buttons">
					...
					<i class="fa fa-check"></i> <input type="radio" name="product_page" value="1" <?php if ($product_page !== '0') { ?>checked="checked"<?php } ?>> Да
					</label>
					<label class="btn btn-primary<?php if ($product_page === '0') { ?> active<?php } ?>">
					<i class="fa fa-times"></i> <input type="radio" name="product_page" value="0" <?php if ($product_page === '0') { ?>checked="checked"<?php } ?>> Нет
					</label>
				</div>
				</div>
			</div>
