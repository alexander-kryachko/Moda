        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-view"><span data-toggle="tooltip" title="Установить галочку если категория является самой главной, не имеет родителей">Первый уровень категории</span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($view) { ?>
                      <input type="checkbox" name="view" value="1" checked="checked" id="input-view" />
                      <?php } else { ?>
                      <input type="checkbox" name="view" value="1" id="input-view" />
                      <?php } ?>
                      &nbsp; </label>
                  </div>
                </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-left"><select name="category_layout[0]" class="form-control">
                          ...
                          <?php if (isset($category_layout[0]) && ( $category_layout[0] == $layout['layout_id'] || $layout['layout_id'] == '3' )) { ?>
