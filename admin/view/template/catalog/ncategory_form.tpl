    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="tab-pane fade" id="tab-data">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="input-template-name">Название шаблона</label>
                <div class="col-sm-10">
                  <input type="text" name="template_name" value="<?php echo $template_name; ?>" id="input-template-name" class="form-control" />
                </div>
            </div>
			<div class="form-group">
