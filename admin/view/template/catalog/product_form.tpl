              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-table-size<?php echo $language['language_id']; ?>">Таблица размеров</label>
                        <div class="col-sm-10">
                            <!-- <?php echo $tbl; ?> -->
                            <textarea name="product_description[<?php echo $language['language_id']; ?>][table_size]" placeholder="Таблица размеров" id="input-table-size<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['table_size'] : ''; ?></textarea>
                        </div>
                    </div>
                  <div class="form-group">
                ...
                <table id="special" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left"><?php echo $entry_customer_group; ?></td>
                      <td class="text-right"><?php echo $entry_priority; ?></td>
                      <td class="text-right"><?php echo $entry_price; ?> (не указывать если есть % скидка)</td>
                      <td class="text-right">Процент %</td>
                      <td class="text-left"><?php echo $entry_date_start; ?></td>
                      <td class="text-left"><?php echo $entry_date_end; ?></td>
                      <td></td>
                    </tr>
                  ...
                  <tbody>
                    ...
                    <tr id="special-row<?php echo $special_row; ?>">
                      ...
                      <!-- input percent -->
                      <td class="text-right"><input type="text" name="product_special[<?php echo $special_row; ?>][percent]" value="<?php echo $product_special['percent']; ?>" placeholder="Процент %" class="form-control" /></td>
                      <!-- input percent -->
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-left"><select name="product_layout[0]" class="form-control">
                          ...
                          <?php if (isset($product_layout[0]) && ( $product_layout[0] == $layout['layout_id'] || $layout['layout_id'] == '2' ) ) { ?>
...
$('#input-table-size<?php echo $language['language_id']; ?>').summernote({height: 300});
...
var special_row = <?php echo $special_row; ?>;
    ...
    function addSpecial() {
      ...
      html += '  <td class="text-right"><input type="text" name="product_special[' + special_row + '][percent]" value="" placeholder="Процент" class="form-control" /></td>';
