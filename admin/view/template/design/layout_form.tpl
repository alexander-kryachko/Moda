          ...
          <table id="route" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="route-row<?php echo $route_row; ?>">
                ...
                <td class="text-left"><input type="text" name="layout_route[<?php echo $route_row; ?>][template]" value="<?php echo $layout_route['template']; ?>" placeholder="<?php echo 'Шаблон'; ?>" class="form-control" /></td>
            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][code]" class="form-control">
                  ...
                  <?php echo $layout_module['position']; ?>
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'content_absolu') { ?>
                        <option value="content_absolu" selected="selected">Absolute</option>
                    <?php } else { ?>
                        <option value="content_absolu">Absolute</option>
                    <?php } ?>
                    ...
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'mainmenu') { ?>
                    ...
                    <option value="content_footer" selected="selected">Подвал</option>
                    <?php } else { ?>
                    <option value="content_footer">Подвал</option>
                    <?php } ?>
...
function addRoute() {
	...
	html += '  <td class="text-left"><input type="text" name="layout_route[' + route_row + '][template]" value="" placeholder="<?php echo 'Шаблон'; ?>" class="form-control" /></td>';
...
function addModule() {
    ...
    html += '    <option value="content_absolu">Absolute</option>';
    ...
    html += '    <option value="content_footer">Подвал</option>';
