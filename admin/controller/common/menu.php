...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['faq_listing'] = $this->url->link('module/reviews/listing', 'token=' . $this->session->data['token'], 'SSL');
		$data['faq_testimonial'] = $this->url->link('module/faq_testimonial/listing', 'token=' . $this->session->data['token'], 'SSL');
		$data['faq_complaints'] = $this->url->link('module/complaints/listing', 'token=' . $this->session->data['token'], 'SSL');
